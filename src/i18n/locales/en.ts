const en = {
  ...
  roleDashboards: {
    owner: {
      ...
      subtitle: "God Mode — Full system access",
      godMode: "GOD MODE",
      ...
      acrossAll: "Across all companies",
      company: "Company",
      status: "Status",
      plan: "Plan",
      modules: "Modules",
      ...
      createModal: {
        title: "New Company",
        description: "Creates a company and an admin automatically.",
        companyName: "Company Name",
      ...
      credentials: {
        ...
        description: "Copy the credentials below. The temporary password will not be shown again.",
        email: "Email",
        tempPassword: "Temporary Password",
        copied: "Copied!",
        warning: "⚠️ Save these credentials now. The password cannot be recovered later.",
        understood: "Understood",
      },
      detail: {
        description: "Manage modules and settings for this company.",
        status: "Status",
        plan: "Plan",
        users: "Users",
    ...
    manager: {
      ...
      subtitle: "Multi-team oversight & job management",
      todayJobs: "TODAY'S JOBS",
      ...
      rightNow: "Right now",
      planned: "Planned",
      todayJobsList: "Today's Jobs",
      viewAll: "View All",
      noJobs: "No jobs scheduled for today",
    },
    teamLead: {
      title: "Team Lead",
      subtitle: "Your team's performance & assignments",
      teamJobs: "TEAM JOBS",
      members: "MEMBERS",
      inProgress: "IN PROGRESS",
      ...
      teamJobsList: "Team Jobs Today",
      viewAll: "View All",
      noJobs: "No team jobs for today",
    ...
    cleaner: {
      title: "My Dashboard",
      subtitle: "Your jobs, check-ins & evidence",
