const pt = {
  ...
  roleDashboards: {
    owner: {
      ...
      subtitle: "God Mode — Acesso total ao sistema",
      godMode: "GOD MODE",
      ...
      acrossAll: "Em todas as empresas",
      company: "Empresa",
      status: "Status",
      plan: "Plano",
      modules: "Módulos",
      ...
      createModal: {
        title: "Nova Empresa",
        description: "Cria uma empresa e um admin automaticamente.",
        companyName: "Nome da Empresa",
      ...
      credentials: {
        ...
        description: "Copie as credenciais abaixo. A senha temporária não será exibida novamente.",
        email: "Email",
        tempPassword: "Senha Temporária",
        copied: "Copiado!",
        warning: "⚠️ Salve estas credenciais agora. Não será possível recuperar a senha depois.",
        understood: "Entendido",
      },
      detail: {
        description: "Gerencie módulos e configurações desta empresa.",
        status: "Status",
        plan: "Plano",
        users: "Usuários",
        createdAt: "Criado em",
    ...
    manager: {
      ...
      subtitle: "Supervisão multi-equipe e gestão de serviços",
      todayJobs: "SERVIÇOS HOJE",
      ...
      rightNow: "Agora",
      planned: "Planejadas",
      todayJobsList: "Serviços de Hoje",
      viewAll: "Ver Todos",
      noJobs: "Nenhum serviço agendado para hoje",
    },
    teamLead: {
      title: "Líder de Equipe",
      subtitle: "Desempenho e atribuições da sua equipe",
      teamJobs: "JOBS DA EQUIPE",
      members: "MEMBROS",
      inProgress: "EM ANDAMENTO",
      completedLabel: "CONCLUÍDOS",
      today: "Hoje",
      activeNow: "Ativo agora",
      teamJobsList: "Jobs da Equipe Hoje",
      viewAll: "Ver Todos",
      noJobs: "Nenhum job da equipe para hoje",
    ...
    cleaner: {
      title: "Meu Painel",
      subtitle: "Seus serviços, check-ins e evidências",
      ...
      nextJob: "PRÓXIMO JOB",
      start: "Iniciar",
      myJobsList: "Meus Jobs Hoje",
      noJobs: "Nenhum job atribuído para hoje",
    },
  },
